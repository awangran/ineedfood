...
var CheckIcon = (props) => /* @__PURE__ */ import_react.default.createElement(import_icon.Icon, {
  viewBox: "0 0 24 24",
  ...props
...
var InfoIcon = (props) => /* @__PURE__ */ import_react.default.createElement(import_icon.Icon, {
  viewBox: "0 0 24 24",
  ...props
}, /* @__PURE__ */ import_react.default.createElement("path", {
  fill: "currentColor",
...
var WarningIcon = (props) => /* @__PURE__ */ import_react.default.createElement(import_icon.Icon, {
  viewBox: "0 0 24 24",
  ...props
}, /* @__PURE__ */ import_react.default.createElement("path", {
  fill: "currentColor",
...
var [AlertProvider, useAlertContext] = (0, import_react_utils.createContext)({
  name: "AlertContext",
  errorMessage: "useAlertContext: `context` is undefined. Seems you forgot to wrap alert components in `<Alert />`"
});
var [AlertStylesProvider, useAlertStyles] = (0, import_react_utils.createContext)({
...
var Alert = (0, import_system.forwardRef)(function Alert2(props, ref) {
  ...
  return /* @__PURE__ */ import_react.default.createElement(AlertProvider, {
    ...
    ref,
    ...rest,
    className: (0, import_utils.cx)("chakra-alert", props.className),
    __css: alertStyles
  })));
});
...
var AlertDescription = (0, import_system2.forwardRef)(function AlertDescription2(props, ref) {
  ...
  return /* @__PURE__ */ import_react.default.createElement(import_system2.chakra.div, {
    ref,
    ...props,
    className: (0, import_utils2.cx)("chakra-alert__desc", props.className),
...
function AlertIcon(props) {
  ...
  return /* @__PURE__ */ import_react.default.createElement(import_system3.chakra.span, {
    display: "inherit",
    ...props,
    className: (0, import_utils3.cx)("chakra-alert__icon", props.className),
    __css: css
...
var AlertTitle = (0, import_system4.forwardRef)(function AlertTitle2(props, ref) {
  ...
  return /* @__PURE__ */ import_react.default.createElement(import_system4.chakra.div, {
    ref,
    ...props,
    className: (0, import_utils4.cx)("chakra-alert__title", props.className),
    __css: styles.title
  });
});
