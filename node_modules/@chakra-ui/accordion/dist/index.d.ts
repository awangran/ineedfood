...
import { Omit as Omit$1, Dict } from '@chakra-ui/utils';
...
interface AccordionProps extends UseAccordionProps, Omit$1<HTMLChakraProps<"div">, keyof UseAccordionProps>, ThemingProps<"Accordion"> {
    /**
...
interface AccordionItemProps extends Omit$1<HTMLChakraProps<"div">, keyof UseAccordionItemProps | "children">, UseAccordionItemProps {
...
declare const useAccordionStyles: () => Dict<SystemStyleObject>;
