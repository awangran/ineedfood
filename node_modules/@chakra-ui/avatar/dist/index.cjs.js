...
var [AvatarStylesProvider, useAvatarStyles] = (0, import_react_utils.createContext)({
...
var Avatar = (0, import_system3.forwardRef)((props, ref) => {
  ...
  return /* @__PURE__ */ import_react.default.createElement(import_system3.chakra.span, {
    ref,
    ...rest,
    className: (0, import_utils2.cx)("chakra-avatar", props.className),
    __css: avatarStyles
...
var AvatarGroup = (0, import_system4.forwardRef)(function AvatarGroup2(props, ref) {
  ...
  const clones = reversedChildren.map((child, index) => {
    ...
    return (0, import_react3.cloneElement)(child, (0, import_utils3.filterUndefined)(childProps));
  });
  const groupStyles = {
    display: "flex",
    alignItems: "center",
  ...
  return /* @__PURE__ */ import_react.default.createElement(import_system4.chakra.div, {
    ...
    __css: groupStyles,
    ...rest,
    className: (0, import_utils3.cx)("chakra-avatar__group", props.className)
...
var AvatarBadge = (0, import_system5.forwardRef)(function AvatarBadge2(props, ref) {
  ...
  return /* @__PURE__ */ import_react.default.createElement(import_system5.chakra.div, {
    ref,
    ...props,
    className: (0, import_utils4.cx)("chakra-avatar__badge", props.className),
    __css: badgeStyles
  });
});
